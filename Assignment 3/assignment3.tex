...
(D) \(\frac{3}{4}\)
\section{Solution}
Let $X$ be the Bernoulli random variable such that $X \sim B \brak{1,0}$ denotes the outcome of the given experiment.\\
...
Probability that a head appears on an odd\\ try is $$\left(\frac{1}{2}\right)\times\left(\frac{1}{2}\right)^{(2n+1)-1}$$
\begin{align}
    \therefore \pr{X=0} &= \sum_{n=0}^{\infty}\left(\frac{1}{2}\right)\times\left(\frac{1}{4}\right)^n \\
